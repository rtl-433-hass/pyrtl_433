"""Mutation-killing tests for pyrtl_433/library.

Every test in this file is written to pass on the *original* source and fail on
at least one specific surviving mutant from the baseline mutmut run.
...
class TestDescriptorFromEntry:
    ...
    def test_minimal_valid_entry(self):
        ...
        from pyrtl_433.library import _descriptor_from_entry
...
import pyrtl_433.library as mp  # noqa: E402
