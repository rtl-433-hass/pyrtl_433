"""Mutation-killing floor tests for pyrtl_433/library.
...
import pyrtl_433.library as mp
...
MAPPING_LOGGER = "pyrtl_433.library"
...
class TestLoadDescriptorFile:
    ...
    def test_non_mapping_yaml_raises_type_error_with_message(self, tmp_path):
        ...
        from pyrtl_433.library import _load_descriptor_file
...
class TestValidateEntryPlatformMessages:
    ...
    def test_empty_string_platform_not_flagged_as_unknown(self):
        ...
        from pyrtl_433.library import _validate_entry
